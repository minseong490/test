  ...
  return (
    <div className="contest-detail">
      ...
      <section className="contest-section">
        <h3 className="contest-section-title">💡 아이디어 기획 단계</h3>
        ...
        <p className="contest-description">
          우리 팀은 '시각장애인을 위한 대중교통 안내 서비스'를 주제로
          선정했습니다. 기존 앱들이 음성 안내에만 의존한다는 점에 착안하여,
          햅틱(진동) 피드백과 고정밀 GPS를 결합한 솔루션을 제안했습니다. 첫날
          밤샘 회의를 통해 페르소나를 설정하고, 사용자 여정 지도(User Journey
          Map)를 그리며 구체적인 기능을 확정했습니다.
        </p>
      </section>
